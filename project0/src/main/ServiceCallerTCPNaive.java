...
/*4*/  private final int    port        = 8088;
/*5*/  private final String msgid       = "dofibo";
/*6*/  private final String msgcontent  = "dofibo(4)";
...
/*13*/CommUtils.outgreen("ServiceCallerTCPNaive|answer:"+answer);
/*14*/CommUtils.outgreen("ServiceCallerTCPNaive|content:"+msg.msgContent());
  }
